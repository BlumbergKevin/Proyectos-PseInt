Algoritmo Barrilete_cosmico
	...
	//papelUnBarrilete (Sup del barrilete) que es la (sup triang ADB + sup triang ABC) / 2
	papelUnBarrilete <- (diametroMayor * diametroMenor/2)/2 + (diametroMayor * diametroMenor/2)/2;
